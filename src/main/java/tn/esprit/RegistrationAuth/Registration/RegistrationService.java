...
import tn.esprit.RegistrationAuth.Registration.Token.*;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
      ...
      request.setPhoneNumber("+216 "+request.getPhoneNumber());
        if (!isValidEmail) {
        ...
        String link = "http://localhost:8082/PharmaLife/registration/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
